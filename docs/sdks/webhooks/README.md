...
with Attio(
    ...
    res = a_client.webhooks.get_v2_webhooks(limit=10, offset=5)
...
with Attio(
    ...
    res = a_client.webhooks.post_v2_webhooks(data={
...
with Attio(
    ...
    res = a_client.webhooks.get_v2_webhooks_webhook_id_(webhook_id="23e42eaf-323a-41da-b5bb-fd67eebda553")
...
with Attio(
    ...
    res = a_client.webhooks.patch_v2_webhooks_webhook_id_(webhook_id="23e42eaf-323a-41da-b5bb-fd67eebda553", data={
        "target_url": "https://example.com/webhook",
        "subscriptions": [
            {
...
with Attio(
    ...
    res = a_client.webhooks.delete_v2_webhooks_webhook_id_(webhook_id="23e42eaf-323a-41da-b5bb-fd67eebda553")

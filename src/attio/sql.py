...
class SQL(BaseSDK):
    ...
    def post_v2_sql(
        ...
        *,
        ...
        request = models.PostV2SQLRequest(
            sql=sql,
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request, False, False, "json", models.PostV2SQLRequest
            ),
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.PostV2SQLResponse, http_res)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = unmarshal_json_response(
                errors.PostV2SQLFilterErrorData, http_res
            )
            raise errors.PostV2SQLFilterError(response_data, http_res)

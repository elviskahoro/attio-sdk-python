...
class PostV2TargetIdentifierAttributesAttributeOptionsSlugConflictError(AttioError):
    r"""Conflict"""
...
@dataclass(frozen=True)
class PostV2TargetIdentifierAttributesAttributeOptionsNotFoundError(AttioError):
    r"""Not Found"""
...
@dataclass(frozen=True)
class PostV2TargetIdentifierAttributesAttributeOptionsValidationTypeError(AttioError):
    r"""Bad Request"""

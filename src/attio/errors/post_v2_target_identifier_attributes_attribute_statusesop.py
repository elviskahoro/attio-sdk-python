...
class PostV2TargetIdentifierAttributesAttributeStatusesSlugConflictError(AttioError):
    r"""Conflict"""
...
@dataclass(frozen=True)
class PostV2TargetIdentifierAttributesAttributeStatusesNotFoundError(AttioError):
    r"""Not Found"""
...
@dataclass(frozen=True)
class PostV2TargetIdentifierAttributesAttributeStatusesValidationTypeError(AttioError):
    r"""Bad Request"""

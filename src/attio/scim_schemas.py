...
class SCIMSchemas(BaseSDK):
        ...
        *,
    ...
    ) -> models.GetScimV2SchemasResponse:
        r"""List SCIM schemas
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="get_/scim/v2/Schemas",
                oauth2_scopes=None,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.GetScimV2SchemasResponse, http_res)
    ...
    async def get_scim_v2_schemas_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
